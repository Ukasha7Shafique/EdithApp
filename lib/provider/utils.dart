...
class Command {
  static final all = [email, browser1, browser2, browser3];

  static const email = 'write email';
  static const browser1 = 'open';
  static const browser2 = 'go to';
  static const browser3 = 'check weather';
}
...
class Utils {
  static void scanText(String rawText) {
    ...
    if (text.contains(Command.email)) {
      ...
      openLink(url: url.toString());
    } else if (text.contains(Command.browser3)) {
      openLink(url: 'www.accuweather.com/');
    }
  }
